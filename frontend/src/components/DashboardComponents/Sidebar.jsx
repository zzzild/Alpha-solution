    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-indigo-950 via-indigo-950/90 to-transparent">
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/10">
          ...
          <button
            onClick={logout}
            className="mt-2.5 w-full flex items-center cursor-pointer justify-center gap-2 px-3 py-2 text-xs font-semibold text-white bg-red-500/70 hover:bg-red-500/90 active:bg-red-600 rounded-lg transition-all duration-200"
          >
            <svg
